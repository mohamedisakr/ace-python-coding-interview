...
def test_insert_in_middle():
    ...
    assert sll.head.data == 5
    assert sll.head.next.data == 10
    assert sll.head.next.next.data == 15
...
def test_insert_with_large_values():
    ...
    assert sll.head.data == large_number - 1
    assert sll.head.next.data == large_number
