...
def calculate_total_income(transactions):
    return sum(trans.amount for trans in transactions if trans.description == 'income')


def calculate_total_expenses(transactions):
    return sum(trans.amount for trans in transactions if trans.description == 'expense')
